...
{
    [Activity(Label = "SmartSchoolsV2", Icon = "@drawable/icon_512_giis",  Theme = "@style/MainTheme",  ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation, ScreenOrientation = ScreenOrientation.Portrait)]

    //Invite App Link
    [IntentFilter(new[] { Android.Content.Intent.ActionView },
                  DataScheme = "https",
                  DataHost = "myedutech.my",
    ...
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        ...
        private void InitFirebaseAuth()
        {
            ...
            .SetApplicationId("1:684520627824:android:3fcbf4a5faa280e8eedeb5")
            .SetApiKey("AIzaSyB-mILSplBS4zYTHNFJnNjtusdXz4_z9Fw")
            .SetDatabaseUrl("https://virtual-giis-default-rtdb.firebaseio.com/")
            .Build();
