...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"bf372f47-95b6-483d-8091-5aab458d76b3\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [25 x i8] c"com.emerging.virtualgiis\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 223, ; number_of_assemblies_in_apk
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [223 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
