...
namespace SmartSchoolsV2.Class
{
    public static class Settings
    {
        ...
        public static string barTextColor
        {
            get => AppSettings.GetValueOrDefault(nameof(barTextColor), string.Empty);

            set => AppSettings.AddOrUpdateValue(nameof(barTextColor), value);
        }
        public static string barBgColor
        {
            get => AppSettings.GetValueOrDefault(nameof(barBgColor), string.Empty);

            set => AppSettings.AddOrUpdateValue(nameof(barBgColor), value);
        }
