...
namespace SmartSchoolsV2.Services
{
    ...
    DateTime check_in_date, string outing_reason, int request_by_id, int request_by_user_role_id, string update_by);
        ...
        #region Wallet
        Task<string> PostAccountTopup(int wallet_id, string wallet_number, decimal topup_amount, string topup_date, string create_by); //mpay
        ...
        Task<string> PostAccountBalance(string wallet_number, int profile_id);
        ...
        #region Payment
        Task<string> PostPaymentRequest(string platform_name, string nric, int wallet_id, string wallet_number, decimal topup_amount, string topup_date, string create_by); //ipay
        Task<string> PostPaymentOnlineOrder(int profile_id, int wallet_id, int order_status_id, int user_role_id, decimal sub_total_amount, decimal tax_amount, decimal total_amount, int payment_method_id, string create_by);
        #endregion
    }
}
