...
namespace SmartSchoolsV2.Services
{
    public class ServiceWrapper : IServiceWrapper
    {
        ...
        //gviss using ipay88
        public async Task<string> PostPaymentRequest(string platform_name, string nric, int wallet_id, string wallet_number, decimal topup_amount, string topup_date, string create_by)
        {
            using (var client = new HttpClient())
            {
                try
                {
                    ...
                    var content = new FormUrlEncodedContent(new[]
                    {
                        new KeyValuePair<string, string>("platform_name", platform_name),
                        new KeyValuePair<string, string>("nric", nric),
                        new KeyValuePair<string, string>("wallet_id", wallet_id.ToString()),
                        new KeyValuePair<string, string>("wallet_number", wallet_number),
                        new KeyValuePair<string, string>("topup_amount", topup_amount.ToString()),
                    ...
                    var response = await client.PostAsync(requestUrl + "/api/v2/payment/request?culture=" + Settings.cultureInfo, content);
                    string result = await response.Content.ReadAsStringAsync();
                    if (response.StatusCode != HttpStatusCode.OK)
                    {
                        return result = ResponseMessage(response.StatusCode);
        ...
        public async Task<string> PostWalletTransfer(int wallet_id, string wallet_number, int recipient_id, string recipient_wallet, decimal transfer_amount, string transfer_date, string create_by)
        {
            using (var client = new HttpClient())
            {
                try
                {
                    ...
                    var response = await client.PostAsync(requestUrl + "/api/v2/wallet/transfer?culture=" + Settings.cultureInfo, content);
                    string result = await response.Content.ReadAsStringAsync();
                    if (response.StatusCode != HttpStatusCode.OK)
                    {
                        return result = ResponseMessage(response.StatusCode);
        ...
        public async Task<string> PostAccountBalance(string wallet_number, int profile_id)
        {
            using (var client = new HttpClient())
            {
                try
                {
                    ...
                    var response = await client.PostAsync(requestUrl + "/api/v2/account/balance?culture=" + Settings.cultureInfo, content);
                    string result = await response.Content.ReadAsStringAsync();
                    if (response.StatusCode != HttpStatusCode.OK)
                    {
                        return result = ResponseMessage(response.StatusCode);
        ...
        public async Task<string> PostPaymentOnlineOrder(int profile_id, int wallet_id, int order_status_id, int user_role_id, decimal sub_total_amount, decimal tax_amount, decimal total_amount, int payment_method_id, string create_by)
        {
            using (var client = new HttpClient())
            {
                try
                {
                    ...
                    var response = await client.PostAsync(requestUrl + "/api/v2/payment/online-order?culture=" + Settings.cultureInfo, content);
                    string result = await response.Content.ReadAsStringAsync();
                    if (response.StatusCode != HttpStatusCode.OK)
                    {
                        return result = ResponseMessage(response.StatusCode);
        ...
        public static Page GetLoginPage()
        {
            ...
            {
                BarBackgroundColor = Color.FromHex("#FCFDBB"),
                BarTextColor = Color.FromHex("#004B18")
            };
