        ...
        public async void PlaceOrder()
        {
            if (conn.IsConnected() == true)
            {
                try
                {
                    ...
                    var t = srvc.PostPaymentOnlineOrder(Settings.profileId, Settings.walletId, 1, Settings.userRoleId, _sub_total_amount, _tax_amount, _total_amount, 1, Settings.fullName);
